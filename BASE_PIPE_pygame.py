...
class Base:
    ...
    def __init__(self, y: int):
        ...
        self.y = y
        # Set the starting x pos for the top left corner of the first base ...
        # ...floor image
        self.x1 = 0
        # Set the starting x pos for the top left corner of the second ...
        # ...base floor image
        self.x2 = self.WIDTH
    ...
    def move(self):
        ...
        # Check if the first base image has moved completely off the ...
        # ...screen to the left
        if self.x1 + self.WIDTH < 0:
            # If so, reset its position to the right of the second base ...
            # ...image to create a seamless loop
            self.x1 = self.x2 + self.WIDTH

        # Check if the second base image has moved completely off the ...
        # ...screen to the left
        if self.x2 + self.WIDTH < 0:
            # If so, reset its position to the right of the next base ...
            # ...image to create a seamless loop
            self.x2 = self.x1 + self.WIDTH


    def draw(self, win):
        """Method to draw the base floor images on the game window to create
        a continuous floor effect.
        Args:
...
class Pipe:
    ...
    TOP_IMG = pygame.transform.flip(
        surface=PIPE_IMG, flip_x=False, flip_y=True
    )
    ...
    def __init__(self, x: int):
        ...
        """
        self.x = x
        # Set the height for the top pipe using a random value between ...
        # ...50 and 450
        self.top_height = randint(50, 450)
        # Calculate the y pos for the top left corner of the top and ...
        # ...bottom pipes
        self.top_y = -(self.HEIGHT - self.top_height)
        self.bottom_y = self.top_height + self.GAP
        # Initialize the 'passed' attribute to False, used to track if the ...
    ...
    def collide(self, bird):
        ...
        Pixel Perfect Collision: Collision is recognised only when
        non-transparent pixel inside an image matrix collides with one inside
        another image matrix.
        Args:
        ...
        # The overlap() method returns the first point of intersection ...
        # ...encountered between this mask and other.

        # Calculate the top_offset and bottom_offset that will be used as ...
        # ...arguments in overlap() function
        ...
        if (t_point is not None) or (b_point is not None):
            # Return True if there is a collision between the bird and ...
            # ...either the top or bottom pipe
            return True
        else:
...
def test_Base_Pipe_classes():
    ...
    while running:
        ...
        pipes_to_remove = []
        # Initialize a boolean variable to track whether a new pipe needs ...
        # ...to be added
        add_pipe = False
        ...
        for pipe in pipes:
            ...
            if (pipe.passed == False) and (pipe.x + pipe.WIDTH < bird.x):
                # If so, mark it as "passed", and set 'add_pipe' to True to ...
                # ...indicate that a new pipe needs to be added to the ...
                # ...'pipes' list
                pipe.passed = True
                add_pipe = True
